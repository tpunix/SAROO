...
char *lang_ar[LANG_STR_NR] = {
	...
	"تشغيل قرس اللعبة المضغوط",
	"أداة التصحيح التسلسلي",
	"تشغيل الملف ثنائي",
	"تحديث البرناهج الثابت",
	"!يتم التحديث... لا توقف الجهاز",
	"!فشل التحديث",
	"!انتهاء التحديث! قم بااشعال",
	"SAROO قائمت التشغيل",
	"...... تشيك القرص",
	"!لم يتم على العثور القرص",
	"!لايساقرص لعبة",
};
